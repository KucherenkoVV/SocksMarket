...
import com.coursework.socksmarket.Exception.WriteFileException;
import com.coursework.socksmarket.services.impl.FilesServiceImpl;
...
public class FilesController {
    ...
    public ResponseEntity<Void> uploadFile(@RequestParam MultipartFile file){
        ...
        try(FileOutputStream fos = new FileOutputStream(dataFile)){
            ...
            throw new WriteFileException("Не удалось загрузить файл.");
        }
    }

    @GetMapping(value = "/exportOperation")
    @Operation(summary = "Скачивание файла операций по товарам в формате JSON.")
    public ResponseEntity<InputStreamResource> downloadOperationFile() throws FileNotFoundException {
